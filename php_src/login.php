...
if (isset($_POST["new_user_registration"])) {
  $_SESSION["wrong_registration"] ="";
...
// $user_security_key     =       $_POST["security_key"];


if ($password == $confirm_password ) {

  // if(!empty($confirm_password) && !empty($user_email) && !empty($password) &&  !email_exsists($user_email)) {

if(email_exsists($user_email)){

  $register_error_message = '<div class="alert alert-warning alert-dismissible fade show" role="alert"> <strong>OOPS!!</strong> Email Already registered or disabled, please try logging in or if any problem contact admin . '.
  '  <button type="button" class="close" data-dismiss="alert" aria-label="Close">  <span aria-hidden="true">&times;</span> </button>  </div>';
    ...
    elseif(empty($user_email)){
      ...
      $register_error_message = '<div class="alert alert-danger alert-dismissible fade show" role="alert">   <strong>OOPS!!</strong> Please enter email correctly '.
      '  <button type="button" class="close" data-dismiss="alert" aria-label="Close">  <span aria-hidden="true">&times;</span> </button>  </div>';
      // $register_error_message ="Please enter email correctly";
}

elseif(empty($password)){
  $register_error_message = '<div class="alert alert-danger alert-dismissible fade show" role="alert">   <strong>OOPS!!</strong>  Please Enter your passowrd '.
  '  <button type="button" class="close" data-dismiss="alert" aria-label="Close">  <span aria-hidden="true">&times;</span> </button>  </div>';
}elseif(empty($confirm_password)) {
  $register_error_message = '<div class="alert alert-danger alert-dismissible fade show" role="alert"> <strong>OOPS!!</strong>  Please Confirm your passowrd '.
  '<button type="button" class="close" data-dismiss="alert" aria-label="Close">  <span aria-hidden="true">&times;</span> </button> </div>';
}else {
  ...
  // $message1 = urlencode("otp number.".$rndno);
  // $to=$user_email;
  // $subject = "OTP";
  // $txt = "OTP: ".$rndno."";
  // $headers = "From: satvikrs2001@gmail.com" . "\r\n";
  ...
  <div class="containerr" id="containerr">
    ...
    <div class="row">
      ...
      <div class="col align-center flex-col sign-in">
        ...
        <div class="form-wrapper verify align-center">

          <form class="" action="otp" method="post">


          <div class="form sign-in">
          <p><h2 style="color:#ffff" class="title pb-3">Verify your Email</h2></p>
            ...
            <div class="input-group">
              ...
              <input  name="password" value="<?php echo $password ?>" type="hidden" placeholder="Password" />
            </div>
            <!-- <div class="input-group">

              <input  name="otp" value="<?php echo $rndno ?>" type="hidden" placeholder="Password" />
            </div> -->
            <button class="btn-primary"   name="send_otp">Verify</button>
              </form>
...
<?php }
  ...
  $register_error_message = '<div class="alert alert-danger alert-dismissible fade show" role="alert">   <strong>OOPS!!</strong>  Password And Confirm Password are not matching '.
    '<button type="button" class="close" data-dismiss="alert" aria-label="Close">  <span aria-hidden="true">&times;</span> </button> </div>';
...
$_SESSION["wrong_registration"] = $register_error_message;
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-207957852-1">
</script>
<script>
...
<a href="#" style="color:white;"  class="btn btn-primary btn-block solid" id="sign-in-btn"  name="login_user" >Login</a>

        <!-- <button name="login_user">Sign in</button> -->
          </form>
          <p>
            <a class="btn btn-link text-primary" href="forgot_password.php"><b >Forgot password?</b></a>
          </p>
          <p>
...
<div class="row content-row signup_content">
  ...
  <div class="col align-items flex-col">
    <div class="text sign-in ">
     ...
     Preparing to launch into codespace 
